...
function factory (type, config, load, typed, math) {
  ...
  const PREFIXES = {
    ...
    CUBIC: {
      ...
      //rus
      ,
      'да': { name: 'да', value: 1e3, scientific: false },
      'г': { name: 'г', value: 1e6, scientific: false },
      'к': { name: 'к', value: 1e9, scientific: true },
      'М': { name: 'М', value: 1e18, scientific: true },
      'Г': { name: 'Г', value: 1e27, scientific: true },
      'Т': { name: 'Т', value: 1e36, scientific: true },
      'П': { name: 'П', value: 1e45, scientific: true },
      'Э': { name: 'Э', value: 1e54, scientific: true },
      'З': { name: 'З', value: 1e63, scientific: true },
      'И': { name: 'И', value: 1e72, scientific: true },

      'д': { name: 'д', value: 1e-3, scientific: false },
      'с': { name: 'с', value: 1e-6, scientific: false },
      'м': { name: 'м', value: 1e-9, scientific: true },
      'мк': { name: 'мк', value: 1e-18, scientific: true },
      'н': { name: 'н', value: 1e-27, scientific: true },
      'п': { name: 'п', value: 1e-36, scientific: true },
      'ф': { name: 'ф', value: 1e-45, scientific: true },
      'а': { name: 'а', value: 1e-54, scientific: true },
